...
export default function TeamCard() {
  return (
      <div className="teamcard bg-white-pink">
         ...
         <div>
             ...
             <p className="mt-3.5 mx-8 text-sm text-black text-center">
             ...
             <button className="font-Opensans mt-8 w-48 h-12 ml-14 uppercase text-sm tracking-widest text-dark-gray border-solid border border-black">
                Contact Me
             </button>
         </div>
      </div>
